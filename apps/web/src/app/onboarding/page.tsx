                        ...
                        <div className="flex justify-between items-center mb-12">
                            <div className="flex-1">
                                ...
                                <h2 className="font-montserrat text-[48px] font-medium text-white leading-[82%]">
                                    Cliff Hänger! <span className="text-[40px]">👋🏻</span>
                                </h2>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        type="email"
                                        value="cliffhanger9696@gmail.com"
                                        disabled
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <option value="" disabled>Choose your favorite language</option>
                                        {languages.map((lang) => (
                                            <option key={lang} value={lang} className="bg-[#3d3d3d] text-white">
                                                {lang}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <option value="" disabled>Choose your level of experience</option>
                                        {proficiencyLevels.map((level) => (
                                            <option key={level} value={level} className="bg-[#3d3d3d] text-white">
                                                {level}
                                            </option>
                                        ))}
                                    </select>
