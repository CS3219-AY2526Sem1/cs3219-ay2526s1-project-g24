...
export default function EditQuestion() {
    ...
    const [selectedTopics, setSelectedTopics] = useState<string[]>(["Arrays", "Hash Table"]);
    const [description, setDescription] = useState("Given an array of integers nums and an integer target, return indices of the two numbers such that they add up to target.");
